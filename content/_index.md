...
#       css_class: fullscreen
  ...
  - block: markdown
    content:
      ...
      #   filename: bead_defects.jpg
      text: |
        <span style=" background: rgba(0,0,0,.3); padding: 5px"> The <span style="color:#F3B26D;font-variant-caps:small-caps;">MInEnS Lab</span> gets its name from the _Ojibwemowin_ word for bead: _manidoominens_. When going from _Ojibwemowin_ to English, _manidoominens_ is translated as _spirit-seed_. In the spirit of its english acronym, our general aim is to seed technologies that transform simple mechanical inputs into the complex assembly and control of materials. We interact with multiple applications (e.g. soft robotics, architecture, medical devices, roll-to-roll manufacturing) while working at the intersections of interfacial, flexible, granular, and active matter. At our core, the <span style="color:#F3B26D;font-variant-caps:small-caps;">MInEnS Lab</span> is curiosity driven as we aim to develop and disseminate knowledge alongside all technical pursuits.
